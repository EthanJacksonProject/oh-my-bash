...
function _omb_theme_PROMPT_COMMAND() {
    ...
    local GIT_THEME_PROMPT_PREFIX="${_omb_prompt_bold_navy}(${_omb_prompt_bold_green}"
    ...
    # Overwrite dirty SCP with same formatting as clean
    local SCM_THEME_PROMPT_DIRTY="${_omb_prompt_bold_navy})${_omb_prompt_reset_color}"
